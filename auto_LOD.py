...
# Override default behaviour which sets author to python-docx
lod_doc.core_properties.author = ''
# Override default behaviour which sets 'Comments' in metadata to 'generated by python-docx'
lod_doc.core_properties.comments = ''
